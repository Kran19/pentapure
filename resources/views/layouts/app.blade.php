  ...
  <div class="app-container" id="app-root">
    <div id="main-app" class="app-main-layout">
      ...
      <div class="bottom-nav" id="bottom-nav">
        ...
        <a href="{{ url($prefix . '/po') }}" class="nav-item {{ $currentRoute == 'po' ? 'active' : '' }}" style="text-decoration:none;">
        ...
        <a href="{{ url($prefix . '/report') }}" class="nav-item {{ $currentRoute == 'report' ? 'active' : '' }}" style="text-decoration:none;">
