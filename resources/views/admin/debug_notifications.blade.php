...
<script>
    ...
    async function sendServerPush() {
        ...
        try {
            const res = await fetch(window.location.origin + '/' + window.userSlug + '/notifications/test');
    ...
    async function checkSubscriptionOnServer() {
        ...
        try {
            const res = await fetch(window.location.origin + '/' + window.userSlug + '/debug-check-sub');
